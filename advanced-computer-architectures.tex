...
\begin{definition}
  \textbf{Trace:} sequence of basic blocks embedded in the control flow graph. 
  ...
  As a result, some traces are executed much more frequently than others (think about code inside loops). 
\end{definition}
